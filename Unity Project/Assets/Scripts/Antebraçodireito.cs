...
public class Antebraçodireito : MonoBehaviour
{
    readonly SerialPort sensor = new SerialPort("COM19", 115200);
    ...
    public void Calibrar12()
    {
        ...
        float xraw2 = ((float.Parse(vec3[0])) / 100);
        float yraw2 = ((float.Parse(vec3[1])) / 100);
        float zraw2 = ((float.Parse(vec3[2])) / 100);
